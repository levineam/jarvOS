...
function advertisedRuntimeAssets() {
  ...
  const required = [
    ...
    'modules/jarvos-storage-janitor/package.json',
    'modules/jarvos-storage-janitor/src/index.js',
    'modules/jarvos-storage-janitor/README.md',
    'docs/contracts/storage-janitor-capacity-preflight.md',
