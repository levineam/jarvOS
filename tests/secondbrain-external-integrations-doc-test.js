...
test('secondbrain external integration inventory preserves authority boundaries', () => {
  ...
  const requiredClaims = [
    ...
    'No indiscriminate ingestion of every AI conversation',
    'future eligible-interaction adapter may produce bounded non-authoritative candidates',
    'this foundation contains no source adapter that does so',
    'destination-owned promotion plus outcome receipt',
    'does not automatically believe, promote, or retain every conversation',
