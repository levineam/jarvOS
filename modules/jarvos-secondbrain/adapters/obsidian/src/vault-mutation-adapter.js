...
function createVaultMutationAdapter({ vaultRoot, vaultId, vaultName = path.basename(vaultRoot || ''), ledger, ledgerPath, transforms, evaluate, maxPollAttempts = 40, probe, ownerId = crypto.randomUUID() } = {}) {
  ...
  return Object.freeze({ capability, execute, ledger: mutationLedger });
}
module.exports = { CAPABILITY_STATES, RESULT_STORE, buildObsidianMutationProgram, createVaultMutationAdapter, runObsidianEval };
