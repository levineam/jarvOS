...
const { additionalContext, stewardshipAdapter } = require('./jarvos-session-turn-hook.js');
...
module.exports = { hydrationMaxChars, main, stewardshipAdapter, stewardshipContext };
