...
function checkControlPlaneModule() {
  ...
  try {
    ...
    const ok = typeof manager.createControlPlaneService === 'function' && typeof context.controlPlane === 'function' && compatible;
    return result('control-plane-module', ok, '@jarvos/control-plane parity module', ok ? 'shared CLI, MCP, and Codex runtime compatibility validated' : 'missing shared service export or Codex runtime declaration');
  } catch (error) {
