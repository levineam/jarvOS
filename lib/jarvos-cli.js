...
const { isValidTimezone } = require('../modules/jarvos-secondbrain/bridge/config/src/resolve-config');
...
For an existing compatible workspace config, --vault, --name, and --timezone
may be omitted: jarvOS reuses those exact configured values.
