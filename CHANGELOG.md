...
## 2026-03-27 — feat: cross-platform core + runtime adapters

- Added portable `core/` behavior files: `AGENTS.md`, `SOUL.md`, and `IDENTITY.md`
- Added runtime adapter docs for OpenClaw and Hermes, including the Hermes setup script and skill
- Added user-facing templates for `USER`, `MEMORY`, `ONTOLOGY`, and `TOOLS`
- Added PMS / governance / session-lifecycle reference docs and the MIT license
- Preserved public-readiness on merge by keeping the sanitized relative-path export map and leaving the removed public Codex workflow out of `main`
