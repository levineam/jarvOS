...
## 6.557 Plan upkeep (canonical reference)

Use `TOOLS.md` (`Plan by Default Policy`) as the source of truth.
...
- Do not redefine Plan rules here; keep policy centralized in TOOLS.md.
